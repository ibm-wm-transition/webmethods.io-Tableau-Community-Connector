  ...
  execute: function(input, options, output) {
    ...
    self
      ...
      .then(res => {
        ...
        if (
          res &&
          Array.isArray(res.tsResponse.projects.project) &&
          res.tsResponse.projects.project.length
        ) {
          res.tsResponse.projects.project.forEach(project => {
            if (project) {
              arr.push({
                id: String(project._attributes.id),
                value:
                  String(project._attributes.name) ||
                  String(project._attributes.id)
              });
            }
          });
